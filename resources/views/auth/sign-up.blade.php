               ...
               <div class="row justify-content-center">
                  <div class="col-md-10">
                     <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                        <div class="card-body">
                           <a href="../../dashboard/index.blade.php" class="navbar-brand d-flex align-items-center mb-3">
                              <!--Logo start-->
                              <!--logo End-->
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="full-name" name="first_name" placeholder=" ">
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
    ...
    <div class="d-flex justify-content-center">
        <button type="submit" class="btn btn-primary">Sign Up</button>
                              ...
                              <p class="mt-3 text-center">
                                 Already have an Account <a href="sign-in.blade.php" class="text-underline">Sign In</a>
                              </p>
                           </form>
                        </div>
                     </div>    
