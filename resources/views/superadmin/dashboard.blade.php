        ...
        <div class="card-body">
            <div class="progress-widget">
                <div id="circle-progress-03" class="text-center circle-progress circle-progress-warning"
                     data-min-value="0" data-max-value="100" data-value="{{ $totalAdmin }}" data-type="percent">
        ...
        <div class="card-body">
            <div class="progress-widget">
                <div id="circle-progress-04" class="text-center circle-progress circle-progress-danger"
                     data-min-value="0" data-max-value="100" data-value="{{ $totalJamaah }}" data-type="percent">
                    <i class="fas fa-users fa-2x text-danger"></i>
                </div>
                <div class="progress-detail">
                    <p class="mb-2">Jamaah</p>
