                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="../../dashboard/auth/sign-in.blade.php">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
              ...
              <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="../../dashboard/app/user-profile.blade.php">Profile</a></li>
                    <li><a class="dropdown-item" href="../../dashboard/app/user-privacy-setting.blade.php">Privacy Setting</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="../../dashboard/auth/sign-in.blade.php">Logout</a></li>
                  </ul>
                </li>
              </ul>
            </div>
                                            ...
                                            <div class="btn btn-icon btn-soft-light me-2">
                                                <div class="btn-inner">
                                                    <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="none">
                                                        <g>
                                                        <g>
                                                        <path d="M17 3.99988L4.99998 3.99998C3.89542 3.99999 3 4.89542 3 5.99998V19C3 20.1046 3.89543 21 5 21H18C19.1046 21 20 20.1046 20 19V6.69039" stroke="currentColor" stroke-linecap="round"/>
                                        ...
                                        <div class="iq-media-group-1">
                                            ...
                                            <a href="#" class="iq-media-1">
                                                <div class="icon iq-icon-box-2 text-danger">
                                                    <svg class="icon-16" width="16"  viewBox="0 0 24 24">
                                        ...
                                        <div class="d-grid grid-flow-col align-items-center justify-content-between mb-2">
                                            ...
                                            <div class="dropdown">
                                                <span class="h5" id="dropdownMenuButton19" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                        <g>
                                                        <g>
                                                        <circle cx="7" cy="12" r="1" fill="black"/>
                                                        <circle cx="12" cy="12" r="1" fill="black"/>
...
<script src="../../assets/js/plugins/kanban.js"></script>
  </body>
</html>
@endsection