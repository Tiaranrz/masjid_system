            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-md-end">
                           {{-- Tombol Tambah Asset --}}
                           <a href="{{ route('admin.inventory.create') }}" class="text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                            <i class="btn-inner">
                ...
                <div class="card-body px-0">
                    <div class="table-responsive">
                        <table id="inventory-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                            <thead>
                                <tr class="ligth">
                                    <th>No</th>
                                    <th>Nama Asset</th>
                            ...
                            <tbody>
                                {{-- Looping data inventaris dari controller --}}
                                @foreach ($inventory as $key => $asset)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        ...
                                        <td>{{ 'Rp' . number_format($asset->asset_price, 0, ',', '.') }}</td>
                                        ...
                                        <td>
                                            ...
                                            @elseif ($asset->condition == 'Rusak Ringan')
                                                <span class="badge bg-warning">{{ $asset->condition }}</span>
                                            @else
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip"
                                                href="{{ route('admin.inventory.edit', $asset->id) }}" aria-label="Edit Asset" data-bs-original-title="Edit Asset">
                                            ...
                                            {{-- Tombol Hapus --}}
                                            <form action="{{ route('admin.inventory.destroy', $asset->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-icon text-danger flex-end" data-bs-toggle="tooltip" aria-label="Hapus Asset" data-bs-original-title="Hapus Asset" onclick="return confirm('Hapus aset ini?')">
                                                <span class="btn-inner">
                                                    {{-- SVG for Delete Icon --}}
                                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{{-- Bagian Peta Lokasi dihilangkan karena tidak relevan untuk Inventaris Aset, kecuali aset tersebut memiliki koordinat --}}
@endsection
